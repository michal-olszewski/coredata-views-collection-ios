Pod::Spec.new do |s|
  ...
  s.source_files  = "CoreData-Views-Collection-ios/Classes", "CoreData-Views-Collection-ios/Classes/Changes", "CoreData-Views-Collection-ios/Classes/Changes/**/*.{h,m}", "CoreData-Views-Collection-ios/Classes/**/*.{h,m}"
